...
class ActorPPOTrainer(ABC):
    def __init__(
        ...
        **kwargs,
        ...
        if backend == "nccl" and self.strategy.args.colocate_all_models and self.strategy.args.colocate_vllm:
...
class ActorModelRayActor(BasePPORole):
    ...
    def save_checkpoint(self, tag, client_states, save_ds_ckpt, save_hf_ckpt):
        args = self.strategy.args
        if save_ds_ckpt:
