...
class Qwen2_5_VLPatch(BasePatch):
    ...
    def _add_get_position_ids():
        ...
        def get_position_ids(self, input_ids, image_grid_thw=None, video_grid_thw=None, attention_mask=None, packing=False, **kwargs):
            position_ids,mrope_position_deltas = self.model.get_rope_index(input_ids=input_ids, image_grid_thw=image_grid_thw, video_grid_thw=video_grid_thw, attention_mask=attention_mask)
            if packing:
